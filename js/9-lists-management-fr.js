...
PageContent.FR = {
  ...
  ListSelector:       'Sélectionne la liste à afficher et à modifier.',
  LabelItems:         'Éléments',
  Items:              'Affiche les éléments de la liste sélectionnée, un élément par ligne.<br>' +
                      'Vous pouvez ajouter, modifier ou supprimer des éléments directement dans cette zone.',
  LabelReloadBtn:     'Bouton Recharger',
  ReloadBtn:          'Recharge la liste sélectionnée depuis la base de données, en abandonnant toute modification non sauvegardée.',
  LabelSaveBtn:       'Bouton Sauvegarder',
  SaveBtn:            'Sauvegarde toutes les modifications apportées à la liste en cours dans la base de données.',
  ...
  ExitBtn:            'Ferme la fenêtre Gestion des listes et retourne au tableau de bord.',
